...
public class LazyAttributeLoader implements PersistentAttributeInterceptor {
	...
	public LazyAttributeLoader(SessionImplementor session, Set<String> uninitializedFields, String entityName) {
	...
	protected final Object intercept(Object target, String fieldName, Object value) {
		if ( uninitializedFields != null && uninitializedFields.contains( fieldName ) ) {
			...
			return ( (LazyPropertyInitializer) session.getFactory().getEntityPersister( entityName ) ).initializeLazyProperty(
					fieldName,
					target,
					session
			);
	...
	public String toString() {
		return "LazyAttributeLoader(entityName=" + entityName + " ,uninitializedFields=" + uninitializedFields+ ')';
	}
	...
	public boolean writeBoolean(Object obj, String name, boolean oldValue, boolean newValue) {
		if ( uninitializedFields != null ) uninitializedFields.remove( name );
		return newValue;
	}
